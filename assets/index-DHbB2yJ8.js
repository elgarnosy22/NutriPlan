(function(){let e=document.createElement(`link`).relList;if(e&&e.supports&&e.supports(`modulepreload`))return;for(let e of document.querySelectorAll(`link[rel="modulepreload"]`))n(e);new MutationObserver(e=>{for(let t of e)if(t.type===`childList`)for(let e of t.addedNodes)e.tagName===`LINK`&&e.rel===`modulepreload`&&n(e)}).observe(document,{childList:!0,subtree:!0});function t(e){let t={};return e.integrity&&(t.integrity=e.integrity),e.referrerPolicy&&(t.referrerPolicy=e.referrerPolicy),e.crossOrigin===`use-credentials`?t.credentials=`include`:e.crossOrigin===`anonymous`?t.credentials=`omit`:t.credentials=`same-origin`,t}function n(e){if(e.ep)return;e.ep=!0;let n=t(e);fetch(e.href,n)}})();var e={calories:2e3,protein:150,carbs:250,fat:65};function t(){n(),r(),o(),i()}function n(){let e=document.getElementById(`foodlog-date`);e&&(e.innerText=new Date().toLocaleDateString(`en-US`,{weekday:`long`,month:`short`,day:`numeric`}))}function r(){let e=JSON.parse(localStorage.getItem(`nutriplan_logs`))||[],t=document.getElementById(`logged-items-list`),n=document.getElementById(`clear-foodlog`),r=document.getElementById(`logged-count`);if(e.length===0){t.innerHTML=`
  ...
  </div>`;document.getElementById(`detailData`).innerHTML=v;let y=document.getElementById(`log-meal-btn`);y&&(y.onclick=()=>{E(t,o,s,l,u)});let b=1,x=0,S=0,C=0,w=0;function T(){document.getElementById(`modal-calories`).innerText=x*b,document.getElementById(`modal-protein`).innerText=S*b+`g`,document.getElementById(`modal-carbs`).innerText=C*b+`g`,document.getElementById(`modal-fat`).innerText=w*b+`g`}function E(e,t,n,r,i){let a=document.getElementById(`log-meal-modal`),o=document.getElementById(`log-meal-content`);x=t,S=n,C=r,w=i,b=1,document.getElementById(`modal-meal-img`).src=e.thumbnail||``,document.getElementById(`modal-meal-name`).innerText=e.name||`Meal Name`,document.getElementById(`servings-input`).value=b,T(),a.classList.remove(`hidden`),a.classList.add(`flex`),setTimeout(()=>{a.classList.remove(`opacity-0`),o.classList.remove(`scale-95`)},10)}function D(){let e=document.getElementById(`log-meal-modal`),t=document.getElementById(`log-meal-content`);e.classList.add(`opacity-0`),t.classList.add(`scale-95`),setTimeout(()=>{e.classList.add(`hidden`),e.classList.remove(`flex`)},300)}document.getElementById(`cancel-log-btn`).onclick=D,document.getElementById(`log-meal-modal`).onclick=e=>{e.target.id===`log-meal-modal`&&D()},document.getElementById(`increase-servings`).onclick=()=>{b++,document.getElementById(`servings-input`).value=b,T()},document.getElementById(`decrease-servings`).onclick=()=>{b>1&&(b--,document.getElementById(`servings-input`).value=b,T())},document.getElementById(`confirm-log-btn`).onclick=()=>{let e=JSON.parse(localStorage.getItem(`nutriplan_logs`))||[],n={id:t.idMeal,name:t.name,image:t.thumbnail,servings:b,totalCalories:x*b,totalProtein:S*b,totalCarbs:C*b,totalFat:w*b,dateAdded:new Date().toISOString()};e.push(n),localStorage.setItem(`nutriplan_logs`,JSON.stringify(e)),r(),Swal.fire({title:`Meal Logged!`,text:`Meal saved to your Food Log!`,icon:`success`,confirmButtonColor:`#10b981`,timer:2e3,showConfirmButton:!1}),D()}}var h=document.getElementById(`search-input`);async function g(e){if(!e||e.trim()===``){l(`chicken`,25);return}let t=`https://nutriplan-api.vercel.app/api/meals/search?q=${e}&page=1&limit=25`;try{s.innerHTML=`<div class="col-span-4 flex justify-center py-12"><div class="animate-spin rounded-full h-12 w-12 border-b-2 border-emerald-600"></div></div>`;let n=await(await fetch(t)).json();n&&n.results&&n.results.length>0?(c=n.results,document.getElementById(`recipes-count`).innerHTML=`Showing ${c.length} recipes`,f()):(c=[],s.innerHTML=`
